      ...
      phases: [
        {
          ...
          description:
            "We kick off by chatting about your goals. I'll dive into user research, competitor analysis, and sort out the core requirements. This helps us spot the real problem and make smart assumptions to guide us.",
        },
        {
          title: 'Brainstorming Ideas',
          description:
            "Next, we map out user scenarios and prioritize features. It's like sketching the blueprint – fun and flexible!",
        },
        {
          title: 'Workshop Vibes',
          description:
            'If it fits, we can hop on a quick workshop to align ideas. Think collaborative sketching or mood boarding.',
        },
        {
          title: 'Prototyping Magic',
          description:
            'I whip up low-fi prototypes, comb through processes, and create wireframes. This is where we demo and iterate fast.',
        },
        {
          title: 'Hi-Fi Polish',
          description:
            'Finally, we go full color: style guides, fonts, icons, and all the juicy details. Pages come to life with custom flair.',
        },
      ],
      ...
      faqs: [
        {
          ...
          answer:
            "Short ones: 2 weeks to nail it. Longer epics: up to 6 months for perfection. Rush jobs? I got you – let's chat!",
        },
        {
          question: "What's the price?",
          answer:
            "Depends on the scope, but I aim for fair and transparent. We talk details first, then I quote something you'll love.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Health, government, e-commerce, automotive, insurance... you name it, I've probably designed for it!",
        },
      ],
    },
    zh: {
  ...
  return (
    <div id="projectflow-root" className="w-full">
      ...
      <div id="design-flow" className="text-center mb-16">
        <p className={`${TYPOGRAPHY.body} ${COLORS.gray500} justify-center`}>{t.intro}</p>
      </div>
        ...
        <div className="space-y-6 max-w-3xl mx-auto">
          {t.faqs.map((faq, index) => (
            <div key={index} className="border-b border-gray-200 pb-6 last:border-b-0">
              ...
              <p className={`${TYPOGRAPHY.bodySmall} ${COLORS.gray600}`}>{faq.answer}</p>
            </div>
          ))}
        </div>
      </div>
